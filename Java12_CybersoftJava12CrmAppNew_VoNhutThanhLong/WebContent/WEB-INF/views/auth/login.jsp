        ...
        <form action="<c:url value="<%=UrlConst.LOGIN %>" />" method="post">
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input id="email" name="email" type="email" required="" value = "${email}" class="form-control form-control-prepended" placeholder="contact@tuanphan.dev">
            ...
            <div class="form-group mb-5">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" name="rememberUsername" checked="" id="remember">
